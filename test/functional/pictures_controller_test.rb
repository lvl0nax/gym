...
class PicsControllerTest < ActionController::TestCase
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post :create, picture: { alt: @picture.alt, description: @picture.description, photo: @picture.photo }
    end
  ...
  test "should update picture" do
    put :update, id: @picture, picture: { alt: @picture.alt, description: @picture.description, photo: @picture.photo }
    assert_redirected_to picture_path(assigns(:picture))
  end
