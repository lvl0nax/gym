...
class NewspagesControllerTest < ActionController::TestCase
  ...
  test "should create newspage" do
    assert_difference('Newspage.count') do
      post :create, newspage: { content: @newspage.content, meta_desc: @newspage.meta_desc, meta_key: @newspage.meta_key, meta_title: @newspage.meta_title, shortc: @newspage.shortc, title: @newspage.title }
    end
  ...
  test "should update newspage" do
    put :update, id: @newspage, newspage: { content: @newspage.content, meta_desc: @newspage.meta_desc, meta_key: @newspage.meta_key, meta_title: @newspage.meta_title, shortc: @newspage.shortc, title: @newspage.title }
    assert_redirected_to newspage_path(assigns(:newspage))
  end
